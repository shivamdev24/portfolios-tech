...
const page = () => {
  return (
   <>
   <Navbar/>
      <div className="px-5 overflow-hidden bg-grid-black/[0.1]">

        {/* herosection */}
        <section className=" relative">
            {/* <div className="absolute top-0 h-full w-full bg-gradient-to-tr   from-[#47bfffd8] to-[#008e72] -z-10"></div> */}
          <div className="max-w-7xl   h-[100vh] mx-auto  z-20 ">

            <Image src={Hero} width={1000} height={1000} className='shadow-md h-[75vh] hidden lg:block absolute  w-[60vw] top-40 -right-[26rem] rounded-lg' alt={'image '}>
            </Image>
            <div className=" w-full h-full lg:h-[100vh] flex justify-start items-center">
              <div className="px-5 mt-5 lg:mt-0 flex flex-col  ">
                ...
                <h1 className="text-5xl flex flex-col lg:text-[8rem] lg:leading-[120px] font-extrabold text-black text-start"><span>Build Your</span> <span className="text-blue-600"> Portfolio</span></h1>
                ...
                <div className="mt-10 grid grid-cols-1 md:grid-cols-2  gap-16 ">
                  <Link className=" text-center py-2 max-w-72 px-4 rounded-lg text-lg bg-blue-500 hover:bg-blue-600  text-white duration-500 font-semibold" href="">Get Started</Link>
        ...
        <section id='feature' className="lg:h-[40vh] flex items-center mt-10">
          <div className="text-black grid grid-cols-1 lg:grid-cols-4 max-w-7xl mx-auto gap-6">
            <div className="hover:shadow-md shadow h-auto duration-500 rounded-lg bg-white p-3 flex flex-col gap-2 justify-center  hover:shadow-blue-500">
              <p><SlidersHorizontal className="bg-blue-500 text-white p-1 rounded w-8 h-8" />  </p>
            ...
            <div className="hover:shadow-md shadow h-auto duration-500 rounded-lg bg-white p-3 flex flex-col gap-2 justify-center  hover:shadow-blue-500">
              <p><Shapes className="bg-blue-500 text-white p-1 rounded w-8 h-8" /></p>
            ...
            <div className="hover:shadow-md shadow h-auto duration-500 rounded-lg bg-white p-3 flex flex-col gap-2 justify-center  hover:shadow-blue-500">
              <p><LifeBuoy className="bg-blue-500 text-white p-1 rounded w-8 h-8" /></p>
              <h2>Accessible & Themable</h2>
              <p>Fully customizable components to match your unique style, ensuring inclusivity for all users.</p>
            </div>
            <div className="hover:shadow-md shadow h-auto duration-500 rounded-lg bg-white p-3 flex flex-col gap-2 justify-center  hover:shadow-blue-500">
              <p ><SquareChartGantt className="bg-blue-500 text-white p-1 rounded w-8 h-8" /></p>
        ...
        <section className="mt-10">
          <div className="max-w-7xl mx-auto text-white grid grid-cols-1 lg:grid-cols-12 gap-4">
            <div className="lg:col-span-8 rounded-md bg-teal-600 p-4">
            ...
            <div className="lg:col-span-4 rounded-md bg-teal-600 p-4">
        ...
        <section className="mt-10">
          <div className="max-w-7xl mx-auto flex flex-col items-center ">
            ...
            <div className=" grid grid-cols-1 lg:grid-cols-12 gap-6   h-full py-20">
              <Card className="lg:col-span-4 h-fit hover:shadow-md">
        ...
        <section className="mt-10">
          <div className="max-w-7xl mx-auto flex flex-col items-center ">
            ...
            <div className=" grid grid-cols-1 lg:grid-cols-12 gap-6   h-full py-20">
              <Card className="lg:col-span-3 h-fit hover:shadow-md">
              ...
              <Card className="lg:col-span-6 h-fit hover:shadow-md">
                <CardContent className="flex flex-col items-start justify-start p-6">
                  <CardTitle>Name</CardTitle>
                  <CardDescription>Prifile</CardDescription>
                  <p className="pt-6">
